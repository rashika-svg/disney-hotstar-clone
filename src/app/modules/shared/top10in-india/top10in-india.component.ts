...
export class Top10inIndiaComponent implements OnInit {
  ...
  rightSwiperButton() {
    ...
    const maxTranslateX = -(this.itemWidth * (this.top10inIndia.length - Math.floor(containerWidth / this.itemWidth)));
